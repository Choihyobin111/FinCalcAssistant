<template>
  <header :class="`header ${themeClass}`">
    <router-link to="/home" class="header-title" @click="handleRedirect1">
      <img style="height:50px" src="@/assets/pictures/FinAssistant-tiny.png"/>
    </router-link>
    <div class="tabs">
      ...
      <router-link to="/calc" class="tab" @click="handleRedirect2">
        <n-icon :component="Toolbox24Filled" :size="20" class="tab-icon"/> 功能大全
      </router-link>
...
<script setup lang="ts">
  ...
  // @ts-ignore
  import { WeatherSunnyLow24Filled, WeatherSunny24Regular, Home12Filled, Calculator24Filled, BookCompass24Filled, LauncherSettings24Filled, Toolbox24Filled } from "@vicons/fluent";
