...
<script setup lang="ts">
  ...
  const menuOptions: MenuOption[] = [
    {
      label: () => h(RouterLink, { to: { name: 'BaseCalcManual'}}, { default: () => '科学计算'}),
      key: 'BaseCalcManual',
    },
    {
      label: () => h(RouterLink, { to: { name: 'cashFlowManual'}}, { default: () => '现金流计算'}),
      key: 'cashFlowManual',
    },
    {
      label: () => h(RouterLink, { to: { name: 'investCalcManual'}}, { default: () => '投资/贷款计算'}),
      key: 'investCalcManual',
    },
    {
      label: () => h(RouterLink, { to: { name: 'personalTaxCalcManual'}}, { default: () => '个税计算'}),
      key: 'personalTaxCalcManual',
    },
    {
      label: () => h(RouterLink, { to: { name: 'depositCalcManual'}}, { default: () => '储蓄计算'}),
